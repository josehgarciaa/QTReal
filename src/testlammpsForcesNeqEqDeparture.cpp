...
void trialcallback(void *ptr, LAMMPS_NS::bigint ntimestep, int nlocal, int *id, double **x, double **f){
	...
	printf("Debug:Generating from site list\n");
        ...
        const Float temp = 1600.*chebyshev::Boltzmann;
        const Float Mu = 0.3;
	    const Float TF = 300;
	    const Float Muend = 0.373;
        ...
        info -> kpm -> ptrFilterEnd -> setFilterParams(std::array<Float,2>({Muend,TF*chebyshev::Boltzmann}));
